//
//  WorkoutCollectionListViewModel.swift
//  SweatSketch
//
...
class WorkoutCollectionListViewModel: ObservableObject {
    ...
    init(parentViewModel: WorkoutCollectionViewModel, workoutCollection: WorkoutCollectionEntity) {
